...
print(a[1:2:-1])                    # 출력 안됨 (step이 음수이면 start가 end보다 커야 함)
print(a[:1:-1])                    # noth 출력

# I think string slicing is definitely trash syntax oooh
# # 인덱싱과 슬라이싱 차이
...
s = "1301"
print(f"{s[0]} {s[1]} {s[3]}")                  # ✅ "1학년 3반 1번" 출력

# # 2️⃣ 학번을 슬라이싱만을 이용해서 학년, 반, 번호로 잘라내기
print(f"{s[::100]} {s[1::100]} {s[3::100]}")                  # ✅ "1학년 3반 1번" 출력